...
pub fn pt_info(pt: u8) -> Option<PtInfo> {
    ...
    match pt {
        10 => Some(PtInfo { sample_rate: 44100, channels: 2, encoding: Encoding::S16Be }),
        11 => Some(PtInfo { sample_rate: 44100, channels: 1, encoding: Encoding::S16Be }),
        112 => Some(PtInfo { sample_rate: 48000, channels: 1, encoding: Encoding::S16Be }),
        113 => Some(PtInfo { sample_rate: 48000, channels: 2, encoding: Encoding::S16Be }),
        116 => Some(PtInfo { sample_rate: 24000, channels: 1, encoding: Encoding::S16Be }),
        117 => Some(PtInfo { sample_rate: 24000, channels: 2, encoding: Encoding::S16Be }),
        119 => Some(PtInfo { sample_rate: 16000, channels: 1, encoding: Encoding::S16Be }),
        120 => Some(PtInfo { sample_rate: 16000, channels: 2, encoding: Encoding::S16Be }),
        122 => Some(PtInfo { sample_rate: 12000, channels: 1, encoding: Encoding::S16Be }),
        123 => Some(PtInfo { sample_rate: 12000, channels: 2, encoding: Encoding::S16Be }),
        125 => Some(PtInfo { sample_rate: 8000, channels: 1, encoding: Encoding::S16Be }),
        126 => Some(PtInfo { sample_rate: 8000, channels: 2, encoding: Encoding::S16Be }),
        _ => None,
    }
}
...
mod tests {
    ...
    #[test]
    fn s16be_full_scale() {
        let info = PtInfo { sample_rate: 24000, channels: 1, encoding: Encoding::S16Be };
    ...
    fn stereo_s16be_extracts_left_channel() {
        ...
        let info = PtInfo { sample_rate: 24000, channels: 2, encoding: Encoding::S16Be };
